...
# Code from here, rebased onto v6.0.1:
# https://github.com/rails/rails/pull/24135
  ...
  module Validations
    class AssociatedValidator < ActiveModel::EachValidator #:nodoc:
      def initialize(options)
        @forward_validation_context = options[:forward_validation_context]
        super(options)
      end
      ...
      private
        ...
        def valid_with_context?(record, parent_validation_context)
          validation_context = parent_validation_context if @forward_validation_context && ![:create, :update].include?(parent_validation_context)
    ...
    module ClassMethods
      ...
      #   value.
      # * <tt>:forward_validation_context</tt> - Specifies whether validation should
